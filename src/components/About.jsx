          ...
          <div className="md:w-2/3 text-center ">
            ...
            <p className="mt-2 text-gray-300 text-left">
              ...
              <span className="font-semibold text-white">UI/UX Design (Figma)</span>,
                <span className="font-semibold text-white">HTML, CSS, JavaScript</span>,
                and advanced frameworks like <span className="font-semibold text-white">React and Node.js</span>,
                  along with <span className="font-semibold text-white">NoSQL databases such as MongoDB</span>. 
                  I’m driven by the challenge of transforming ideas into innovative, scalable, and functional 
                  web applications.
            </p>
          ...
          >
            ...
            <div className="mt-4">
              ...
              <ul className="list-disc pl-6 text-gray-300 mt-2">
                ...
                <li>Back-end: Node.js, Express, DataBase NoSQL (MongoDB)</li>
