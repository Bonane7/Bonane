...
const Services = () => {
  return (
    <div>
      {/* Section Services */}
      <section id="Services" className=" py-10 text-center ">
        ...
        <div className="flex flex-wrap justify-center gap-6 mt-6">
          {servicesData.map((service, index) => (
            <motion.div
              ...
              className="w-full sm:w-[300px] md:w-[280px] mx-5 lg:w-[300px] bg-gray-800 p-6 rounded-lg shadow-lg transition-transform duration-300"
            >
              {/* Icône + Titre */}
