...
const Home = () => {
  ...
  return (
    <section
      id="home"
      className="rounded-lg min-h-4/5 w-4/5 mt-12 mx-auto flex flex-col md:flex-row px-2 py-0 bg-gray-900 text-white overflow-hidden"
    >
      {/* Première carte */}
      <motion.div
      ...
      >
        ...
        <div className="flex flex-col items-center mt-2">
          <motion.img
            src={profilePic}
            alt="Profile"
            className="w-60 h-60 object-cover rounded-lg border-1 mt-4 pt-1 border-blue-500"
      ...
      <div className="relative w-full h-[400px] bg-gray-900 flex flex-col justify-center items-center text-white overflow-hidden">
        ...
        <video
          ...
          loop
          muted
          className="absolute rounded-b-lg top-0 left-0 w-full h-full object-cover opacity-50 hidden md:block"
        >
